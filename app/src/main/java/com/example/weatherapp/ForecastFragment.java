...
import com.example.weatherapp.Adapter.WeatherForecastAdpater;
...
public class ForecastFragment extends Fragment {
    ...
    private void displayForecastWeather(WeatherForecastResult weatherForecastResult) {
        ...
        WeatherForecastAdpater adpater = new WeatherForecastAdpater(getContext(), weatherForecastResult);
        recycler_forecast.setAdapter(adpater);
    }
